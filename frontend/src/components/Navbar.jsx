      ...
      <div className="bg-white shadow-sm">
        <div className="mx-auto px-4 py-2 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4 w-[200px]">
            ...
            <Link to="/account" className='w-8 h-8 rounded-full bg-gray-300 flex items-center justify-center text-xl text-gray-700' >{user.name.slice(0,1).toUpperCase()}</Link>
          </div>
        </div>
      </div>
    </div>
